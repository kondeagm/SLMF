...
NavDisciplines = function() {
    ...
    this.settings = {
        slmf: {
            ...
            item: $(".header-content.slmf"),            
        },
        team: {
            background: $Home.find(".home-bg .team"),
            header: $Home.find(".home-content header .team"),
            headerSubs: $Home.find(".home-content .team .logo, .home-content .team .bottom"),
            description: $Home.find(".home-content header .team span .description"),
            item: $(".header-content.team"),            
        },
        labs: {
            background: $Home.find(".home-bg .labs"),
            header: $Home.find(".home-content header .labs"),
            headerSubs: $Home.find(".home-content .labs .logo, .home-content .labs .bottom"),
            description: $Home.find(".home-content header .labs span .description"),
            item: $(".header-content.labs"),            
        },
        bbd: {
...
NavDisciplines.prototype.bind = function() {
    ...
    that = self;
    initSlider();
    //onButtonEvent(null,self.settings.labs);

    function initSlider()
    {
        self.backSlide=self.settings.team;

        self.settings.slider.timer = setInterval(function(){
            nextSlide();
        },5000);
    ...
    function nextSlide()
    {
        //console.log("nextSlide->r"+self.settings.slider.currentSlide);

        self.settings.slider.currentSlide++;
        if(self.settings.slider.currentSlide>2)
        {
            self.settings.slider.currentSlide=0;
        }
        switch(self.settings.slider.currentSlide)
        {
            case 0 :onButtonEvent(null,self.settings.slmf);
                break;
            case 1 :onButtonEvent(null,self.settings.team);
                break;
            case 2 :onButtonEvent(null,self.settings.labs);
                break;        
        }
    }
    ...
    function onButtonEvent(event, slide) {
        ...
        console.log(self.backSlide);
        */
        $(".home-content .header-content").css("z-index",1);
        $(slide.item).css("z-index",2);
        //same slide?
    ...
    settings.bbd.button.mouseenter(function(e) {
        ...
        clearInterval(self.settings.slider.timer);
    });
    ...
    settings.navigationBar.mouseleave(function(e) {
        if (self.backSlide) {
            ...
            //console.log("self.settings.slider.currentSlide->"+self.settings.slider.currentSlide);
            switch(self.settings.slider.currentSlide)
            {
                case 0:onButtonEvent(null, settings.slmf);
                break;
                case 1:onButtonEvent(null, settings.team);
                break;
                case 2:onButtonEvent(null, settings.labs);
                break;
            }
            initSlider();
        }
    ...
    hideInactiveSlides();
    //overs
    /*this.slide.HomeSlider.on("mouseenter",".go_left",this.go_left_over);
    this.slide.HomeSlider.on("mouseleave",".go_left",this.go_left_leave);

    this.slide.HomeSlider.on("mouseenter",".go_right",this.go_left_over);
    this.slide.HomeSlider.on("mouseleave",".go_right",this.go_right_leave);*/
    //clicks    
...
Home = {
    navDiscipliness: null,
    init: function(images) {
        navDisciplines = this.navDiscipliness;
        this.cachedElements();
        var navPilars = new NavPilars();
        navDisciplines = new NavDisciplines();
        ...
        _onLoadImages(images, function() {
            ...
            $Home.removeLoader({
                onComplete: function() {
                    resizeBackgrounds();
                    thats.tlIntro = new TimelineLite({});
                    tlIntro = thats.tlIntro;
