$(function () {
    ...
    dropbox.filedrop({
        ...
        maxfiles: 1,
        maxfilesize: 1,
        url: '/Disciplina/UploadAcronym/' + id_image_file,
        uploadFinished: function (i, file, response) {
            ...
            if (json.estado > 0) {
                ...
                document.getElementById('main-container-drop-icon').style.display = 'inherit';
            }
            else {
                $('#image-uploaded').show();
        ...
        uploadStarted: function (i, file) {
            document.getElementById('main-container-drop-icon').style.display = 'none';
            $('#buttonback').hide();
            $('#waitter').show();
            fileIndex++;
            createImage(file);
