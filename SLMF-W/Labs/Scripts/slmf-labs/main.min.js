...
List.prototype.init = function() {
	...
	this.settings.is_Mobile= (isMobile.apple.phone || isMobile.android.phone || isMobile.seven_inch);
	console.log("is mobile->");
	console.log(this.settings.is_Mobile);
	this.initTimeline();
	this.bind();
...
List.prototype.gotoSlide= function(isFromBtn)
{
	...
	switch(this.settings.slider.current)
	{
		...
		break;
		case 1:this.SlidermoveTo("-100%",slider.tlEnergia,slider.menu.tlMenuItem1,isFromBtn,true);//kai 
		...
		break;
		case 3:this.SlidermoveTo("-380%",slider.tlRegula,slider.menu.tlMenuItem3,isFromBtn,true);//graham
